...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rng");
    reader.add_event(12, 10, "end", "model_rng");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rng
  : public stan::model::model_base_crtp<model_rng> {
private:
        int K;
        int N;
        vector_d theta;
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rng_namespace::model_rng";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rng_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_rng_namespace::model_rng stan_model;
#ifndef USING_R
